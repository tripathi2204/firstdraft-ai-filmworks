...
const AIPitchDeck = () => {
  const features = [
    "AI Generated Images created based on the script",
    "Editable File Link provided in Industry-Format",
      ...
      <section className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-accent font-body mb-8">
            Visually eye-catching presentations
          </p>
          
          <img 
            src={pitchDeckImage}
            alt="Professional AI pitch deck presentation"
          ...
          <p className="text-lg font-body text-foreground/90 leading-relaxed max-w-4xl mx-auto">
            I create high-impact pitch materials — including film pitch decks (video or static), TV-show bibles, 
            visual treatments, electronic press kits (EPKs), director's treatments, and TVC treatments — designed 
            to capture the attention of film executives and investors. Using AI-generated imagery matched to your 
            project's tone and storyline, each presentation delivers a concise, visually engaging showcase of your 
            concept, ensuring your idea makes a strong and lasting impression.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground font-body">
              Tell us about your AI pitch deck needs
            </p>
          </div>
