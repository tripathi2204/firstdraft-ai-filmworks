    ...
    <div className="min-h-screen bg-gradient-hero">
      ...
      <section className="pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto text-center">
          ...
          <img 
            src={scriptBreakdownImage}
            alt="Professional script breakdown sheets"
          ...
          <p className="text-lg font-body text-foreground/90 leading-relaxed max-w-4xl mx-auto">
            Using AI-powered workflows and expert oversight, I deliver detailed, scene-by-scene script breakdowns 
            that identify every key production element — including cast and extras, props, wardrobe and costumes, 
            makeup and hair, sets and set dressing, special effects (SFX) and visual effects (VFX), vehicles, 
            animals, and more. I also provide precise one-liners to ensure nothing is overlooked, giving your 
            team everything they need to stay on budget, on schedule, and fully prepared for production.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground font-body">
              Tell us about your script breakdown needs
            </p>
          </div>
